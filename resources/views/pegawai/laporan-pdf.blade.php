...
<body>
    ...
    <div class="header">
        ...
        <div class="info">
            <span><strong>Periode:</strong> {{ $hasil->periode->nama }}</span>
    ...
    <div class="summary-grid">
        <div class="summary-card bg-blue">
            ...
            <div style="font-size:7px;">× {{ $bobot->bobot_self ?? 20 }}%</div>
        </div>
        <div class="summary-card bg-green">
            <div class="label">Atasan Langsung</div>
            <div class="value text-green">{{ $hasil->nilai_atasan_langsung ?? 0 }}</div>
            <div style="font-size:7px;">× {{ $bobot->bobot_atasan_langsung ?? 50 }}%</div>
        </div>
        <div class="summary-card bg-yellow">
            ...
            <div style="font-size:7px;">× {{ $bobot->bobot_atasan_penilai ?? 30 }}%</div>
        </div>
    ...
    @if($detailSelf && isset($detailSelf['kpi']))
        ...
        <div class="sub-section">KPI (Bobot: {{ $bobot->bobot_kpi ?? 70 }}%)</div>
        <table>
            <thead>
                <tr>
                    <th width="4%">No</th>
        ...
        <div class="sub-section">Kompetensi (Bobot: {{ $bobot->bobot_kompetensi ?? 15 }}%)</div>
        <table>
            <thead>
                <tr>
                    <th width="4%">No</th>
        ...
        <div class="sub-section">Core Values (Bobot: {{ $bobot->bobot_core_values ?? 15 }}%)</div>
        <table>
            <thead>
                <tr>
                    <th width="4%">No</th>
    ...
    @if(isset($penilaian['atasan_langsung']))
        ...
        @if($detailAtasan && isset($detailAtasan['kpi']))
            ...
            @endif
        @else
            <p class="no-data">Tidak ada data penilaian dari Atasan Langsung</p>
        @endif
    @else
    ...
    @if(isset($penilaian['atasan_penilai']))
        ...
        @if($detailPenilai && isset($detailPenilai['kpi']))
            ...
            @endif
        @else
            <p class="no-data">Tidak ada data penilaian dari Atasan Penilai</p>
        @endif
    @else
        <p class="no-data">Belum ada penilaian dari Atasan Penilai</p>
    @endif
    @else
    <!-- Jika tidak ada atasan penilai -->
    <div class="info-box">
        <p>
