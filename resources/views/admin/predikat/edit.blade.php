...
@section('title', 'Edit Predikat Kinerja')

@section('content')
<div class="space-y-4">
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Predikat</h1>
            <p class="text-sm text-gray-500">Perbarui data predikat kinerja pegawai</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('admin.predikat.update', $predikat->id) }}" method="POST" id="formPredikat">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama" id="nama_predikat" value="{{ old('nama', $predikat->nama) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="keterangan" value="{{ old('keterangan', $predikat->keterangan) }}"
                ...
                <div>
                    ...
                    <input type="number" name="batas_bawah" id="batas_bawah" value="{{ old('batas_bawah', $predikat->batas_bawah) }}" required
                ...
                <div>
                    ...
                    <input type="number" name="batas_atas" id="batas_atas" value="{{ old('batas_atas', $predikat->batas_atas) }}" required
                           step="0.01" min="0" max="100"
                ...
                <div>
                    ...
                    <div class="flex items-center gap-3">
                        <input type="color" name="warna_text" id="warna_text" 
                               value="{{ old('warna_text', $predikat->warna_text ?? '#000000') }}"
                ...
                <div>
                    ...
                    <div class="flex items-center gap-3">
                        <input type="color" name="warna_latar" id="warna_latar"
                               value="{{ old('warna_latar', $predikat->warna_latar ?? '#e5e7eb') }}"
                               class="w-12 h-12 p-1 border border-gray-300 rounded-lg cursor-pointer">
            ...
            <div class="mt-6 p-4 border border-gray-200 rounded-lg bg-gray-50">
                ...
                <div class="flex items-center gap-4">
                    <span id="preview-badge" 
                          ...
                          style="color: {{ old('warna_text', $predikat->warna_text ?? '#000000') }}; background-color: {{ old('warna_latar', $predikat->warna_latar ?? '#e5e7eb') }}">
                        {{ old('nama', $predikat->nama) }}
                    </span>
                    <span class="text-sm text-gray-500">
                        Nilai: {{ old('batas_bawah', $predikat->batas_bawah) }} - {{ old('batas_atas', $predikat->batas_atas) }}
                    </span>
                </div>
            </div>
            ...
            <div class="mt-6 pt-4 border-t border-gray-200 flex justify-end gap-3">
                ...
                <button type="submit" class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition">
                    <i class="fas fa-save mr-2"></i> Update Predikat
                </button>
            </div>
        </form>
    </div>
